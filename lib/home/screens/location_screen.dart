...
class LocationScreen extends StatelessWidget {
  const LocationScreen({super.key, this.onSelectLocation, this.selectedLocation});
      ...
      body: Stack(
        children: [
          Obx(() => GoogleMap(
            onMapCreated: (mapController) {
              ...
              WidgetsBinding.instance.addPostFrameCallback((callback) {
                if (selectedLocation != null) {
                  ...
                  controller.mapController.animateCamera(CameraUpdate.newLatLng(selectedLocation!));
            ...
            onTap: (argument) => controller.onMapTap(argument, onSelectLocation: onSelectLocation),
          ...
          Positioned(
            ...
            right: 20,
            child: InkWell(
              onTap: () => controller.getCurrentLocation(context, onSelectLocation: onSelectLocation),
