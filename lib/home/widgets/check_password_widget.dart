...
class _CheckPasswordWidgetState extends State<CheckPasswordWidget> with SingleTickerProviderStateMixin {
                        ...
                        () => TextButton(
                          onPressed: () async {
                            ...
                            if (await controller.checkPassword()) {
                              await animationCon.reverse();
                              widget.onCorrectCheck(controller.passwordController.text.trim());
