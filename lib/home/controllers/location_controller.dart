...
class LocationController extends GetxController {
  ...
  void onMapTap(LatLng position, {void Function(LatLng selectedLatLng, String address)? onSelectLocation}) async {
  ...
  Future<void> getCurrentLocation(BuildContext context, {void Function(LatLng selectedLatLng, String address)? onSelectLocation}) async {
    try {
      isLoading(true);
      ...
      mapController.animateCamera(CameraUpdate.newLatLngZoom(currentLatLng, 14.0));
    } catch (e) {
      HomeHelper.showCustomSnackBar(context, 'Error while get your location. Try again.', isError: true);
