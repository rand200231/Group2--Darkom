...
class CreateExperienceController extends GetxController {
  ...
  Future<void> pickImages(BuildContext context) async {
    try {
      ...
      HomeHelper.showCustomSnackBar(context, "Failed to pick images: $e", isError: true);
    }
  }
  ...
  Future<List<String>> uploadImages() async {
    ...
    final List<String> imageUrls = await FirebaseStorageService.uploadMultipleImages(
      selectedImages,
      'experiences/images',
    );
