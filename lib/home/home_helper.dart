...
class HomeHelper {
  ...
  static void showResultDialog(BuildContext context, {String title = 'Confirmation', String desc = "Done Successfully"}) {
    showDialog(
      context: context,
      barrierDismissible: false, // Prevent closing by tapping outside
      builder: (BuildContext context) {
  ...
  static Future<void> pickTime(BuildContext context, Rx<TimeOfDay?> time, [TimeOfDay? initialTime]) async {
    // Pick Time
